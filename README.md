...
🐍 **Python since 2013** | 🏗️ **Senior Backend Engineer**
...
> 11+ years designing backend systems that scale. From high-throughput APIs to real-time ML inference pipelines — I architect it, build it, and ship it.
...
- **System Architecture** - Designing distributed backends from scratch, microservices, event-driven systems
- **ML in Production** - Deploying real-time prediction engines with LSTM/GRU neural networks
- **API Design** - RESTful & GraphQL APIs that handle thousands of requests/sec
- **Mentoring** - Helping junior & mid engineers level up their backend craft

## GitHub Activity

![GitHub Contribution Graph](https://ghchart.rshah.org/bikerlfh)

## Connect

[![LinkedIn](https://img.shields.io/badge/-Luis_Henriquez-0077B5?style=flat-square&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/bikerlfh)
[![GitHub](https://img.shields.io/badge/-Follow-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/bikerlfh)
